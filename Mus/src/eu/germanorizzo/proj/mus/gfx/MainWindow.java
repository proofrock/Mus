...
import eu.germanorizzo.proj.mus.*;
import eu.germanorizzo.proj.mus.internals.*;
...
public class MainWindow extends JFrame {
	...
	public MainWindow() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(MainWindow.class
				.getResource("/eu/germanorizzo/proj/mus/gfx/icons/d22/Emoji Natur-04-22.png")));
		...
		lblFileNumber.setIcon(new ImageIcon(MainWindow.class
				.getResource("/eu/germanorizzo/proj/mus/gfx/icons/d22/Emoji Objects-127-22.png")));
		...
		lblFileOk.setIcon(new ImageIcon(MainWindow.class
				.getResource("/eu/germanorizzo/proj/mus/gfx/icons/d22/Emoji Smiley-03-22.png")));
		...
		lblFileKo.setIcon(new ImageIcon(MainWindow.class
				.getResource("/eu/germanorizzo/proj/mus/gfx/icons/d22/Emoji Smiley-17-22.png")));
		...
		lblSize.setIcon(new ImageIcon(MainWindow.class
				.getResource("/eu/germanorizzo/proj/mus/gfx/icons/d22/Emoji Objects-98-22.png")));
		panel.add(lblSize);
		...
		btOpen.setIcon(new ImageIcon(MainWindow.class
				.getResource("/eu/germanorizzo/proj/mus/gfx/icons/d22/Emoji Objects-88-22.png")));
		toolBar.add(btOpen);
		...
		btSave.setIcon(new ImageIcon(MainWindow.class
				.getResource("/eu/germanorizzo/proj/mus/gfx/icons/d22/Emoji Objects-87-22.png")));
		...
		btClear.setIcon(new ImageIcon(MainWindow.class
				.getResource("/eu/germanorizzo/proj/mus/gfx/icons/d22/Emoji Symbols-112-22.png")));
